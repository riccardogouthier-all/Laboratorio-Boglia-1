...
def sostituisci_ultimo_valore(tupla_liste, valore):
    ...
    In ingresso =>  Tupla_liste: Tupla contenente SOLO liste
...
if controllo_liste_tupla(TuplaIN) == False:
    ...
    if any(len(lista) == 0 for lista in TuplaIN):   
        ...
        per cui inserendo un ciclo for e una condizione controlla se la condizione viene restituita almeno una volta dal ciclo e stampa l'errore
        '''
